  ...
  <section class="data mt-5">
    ...
    <section class="row m-0 p-0">
      <section class="col-8 offset-2 jumbotron mt-5 shadow">
        <h2 style="padding-bottom: 20px;margin-bottom:25px;border-bottom: 3px solid #716611;">Create news</h2>
        <form action="news/insert.php" method="post" enctype="multipart/form-data">
          ...
          <section class="form-group">
            ...
            <textarea name="keywords" id="keywords" style="resize:none;height:100px;"
                      placeholder="please enter keywords news" value="" class="form-control"></textarea>
          </section>
          <section class="form-group">
            <label for="description">description : </label>
            <textarea name="description" id="description" style="resize:none;height:100px;"
                      placeholder="please enter description news" value="" class="form-control"></textarea>
          </section>
          <section class="form-group">
            <label for="bodyNews">bodyNews : </label>
            <textarea name="bodyNews" id="bodyNews" style="resize:none;height:500px;"
                      placeholder="please enter bodyNews news" value="" class="form-control"></textarea>
          </section>
          <section class="form-group mt-4">
            <input type="submit" class="btn btn-primary" value="create news">
          </section>
          <section class="form-group mt-4">
            <a type="submit" class="btn btn-success" href="show_details_news.php">show details news</a>
          </section>
        </form>
      </section>
    </section>
